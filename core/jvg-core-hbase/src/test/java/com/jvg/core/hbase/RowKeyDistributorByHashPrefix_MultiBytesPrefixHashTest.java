...
public class RowKeyDistributorByHashPrefix_MultiBytesPrefixHashTest extends
		RowKeyDistributorTestBase {
	...
	public static class MultiBytesPrefixHash implements
		...
		private static final byte[][] ALL_PREFIXES = new byte[][] { PREFIX1,
				PREFIX2, PREFIX3 };

		@Override
		public byte[] getHashPrefix(byte[] originalKey) {
			return ALL_PREFIXES[Math
					.abs(originalKey[originalKey.length - 1] % 3)]; // close to
																	// random
																	// prefix
		}
